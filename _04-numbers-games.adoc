...
link::https://groups.google.com/forum/#!topic/comp.lang.scheme/1owCrv0H3lk[question in comp.lang.scheme group]

And by the way, they show an implementation of `atom?' right in the beginning of the book, and now they say here it is a primitive. What is going on?
